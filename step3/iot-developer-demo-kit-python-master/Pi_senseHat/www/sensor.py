...
class SenseHat(object):
    def get_temperature(self):
        ...
        temperatureData = [{"temperature" : 35.35, "ts" : 1476833997042},
            ...
            "ts" : 1476833997042},{"temperature" : 105.35,
            "ts" : 1476833997042},{"temperature" : 115.35,
            "ts" : 1476833997042},{"temperature" : 125.35,
            "ts" : 1476833997042},{"temperature" : 135.35,
            "ts" : 1476833997042},{"temperature" : 145.35,
            "ts" : 1476833997042}
            ]
        temperature = temperatureData[randint(0, len(temperatureData))]["temperature"]
        print(temperature)
        return temperature
